...
def read_dataset(filename,bos='<bos>',eos='<eos>'):
    ...
    for line in istream:
        #line = line.split('=')[0] # for wiki 103
        ...
        def generate_batch(self,batch_size,
            ...
            while True:
               ...
               if incremental:
                   ...
                   batchlen = max([len(self.sentences[idx]) for idx in self.idxes[sidx:eidx]])
                   X = [self.sentences[idx] for idx in self.idxes[sidx:eidx]]
                   Y = [self.sentences[idx] for idx in self.idxes[sidx:eidx]]
               #padding
